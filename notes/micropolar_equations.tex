...
The dispersion relation can be exemplified in the following set of figures. Where we can see the cut-off frequency for the rotational wave and the
limit cases for the phase and group speeds.
\begin{figure}[H]
\centering
		\includegraphics[height=1.8 in]{img/disp_micropolar_freqs.pdf}
		\includegraphics[height=1.8 in]{img/disp_micropolar_phase_speed.pdf}
		\includegraphics[height=1.8 in]{img/disp_micropolar_group_speed.pdf}
\caption{Dispersion relations for a material with properties: $\rho = 1\times 10^5$, $J=1\times 10^4$, $\lambda=2.8 \times 10^{10}$, $\gamma + \epsilon=1.62 \times 10^9$, $\mu = 4\times 10^9$, $\alpha = 2 \times 10^9$ as in \cite{kulesh2009}.}
...
As in the case micropolar media, we can summarize these results in a set of figures.
\begin{figure}[H]
\centering
...
\caption{Dispersion relations for a material with properties: \(\rho = 1\times 10^5\), \(\lambda=2.8 \times 10^{10}\),  \(\mu = 4\times 10^9\), \(\eta = 1.6 \times 10^9\).}
\label{fig:dispersion}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5in]{img/{CST_plane_wave-L=0.01}.png}\\
  \includegraphics[width=5in]{img/{CST_plane_wave-L=0.03}.png}\\
  \includegraphics[width=5in]{img/{CST_plane_wave-L=0.1}.png}\\
  \caption{Reflection of an incident P-wave on a halfspace for different length scales. The angle of incidence is \(\pi/6\) rad, the P-wave speed is \(c_1=2\), the (classical) S-wave speed is \(c_2=1\), and the length scales are \(l = \{0.01, 0.03, 0.1\}\) (from top to bottom). It is clearly seen how the dispersion increases while the length scale parameter increases.}
\end{figure}
